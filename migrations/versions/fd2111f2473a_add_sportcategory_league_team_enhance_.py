...
def upgrade():
    ...
    if not inspector.has_table('sport_category'):
        ...
        with op.batch_alter_table('sport_category', schema=None) as batch_op:
            batch_op.create_index(batch_op.f('ix_sport_category_name'), ['name'], unique=True)
            batch_op.create_index(batch_op.f('ix_sport_category_slug'), ['slug'], unique=True)
    ...
    if not inspector.has_table('league'):
        ...
        with op.batch_alter_table('league', schema=None) as batch_op:
            ...
            batch_op.create_index(batch_op.f('ix_league_sport_category_id'), ['sport_category_id'], unique=False)
    ...
    with op.batch_alter_table('sport_event', schema=None) as batch_op:
        batch_op.add_column(sa.Column('league_id', sa.Integer(), nullable=False, server_default='0')) # Add server_default temporarily
        ...
        batch_op.add_column(sa.Column('home_team_name_raw', sa.String(length=150), nullable=True))
        batch_op.add_column(sa.Column('away_team_name_raw', sa.String(length=150), nullable=True))
        ...
        batch_op.add_column(sa.Column('home_score_period1', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('away_score_period1', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('home_score_period2', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('away_score_period2', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('home_score_overtime', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('away_score_overtime', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('home_score_penalties', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('away_score_penalties', sa.Integer(), nullable=True))
        ...
        constraint_exists = any(fk['name'] == 'fk_sport_event_sport_key_sport' for fk in foreign_keys)
        if constraint_exists:
            batch_op.drop_constraint('fk_sport_event_sport_key_sport', type_='foreignkey')
        ...
        batch_op.create_index(batch_op.f('ix_sport_event_away_team_id'), ['away_team_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_sport_event_home_team_id'), ['home_team_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_sport_event_league_id'), ['league_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_sport_event_status'), ['status'], unique=False)

        batch_op.create_foreign_key(batch_op.f('fk_sport_event_league_id_league'), 'league', ['league_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_sport_event_away_team_id_team'), 'team', ['away_team_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_sport_event_home_team_id_team'), 'team', ['home_team_id'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('sport_event', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('sport_key', sa.VARCHAR(length=100), nullable=False))
        batch_op.add_column(sa.Column('home_team', sa.VARCHAR(length=100), nullable=True))
        batch_op.add_column(sa.Column('away_team', sa.VARCHAR(length=100), nullable=True))
        batch_op.drop_constraint(batch_op.f('fk_sport_event_home_team_id_team'), type_='foreignkey')
        batch_op.drop_constraint(batch_op.f('fk_sport_event_away_team_id_team'), type_='foreignkey')
        batch_op.drop_constraint(batch_op.f('fk_sport_event_league_id_league'), type_='foreignkey')
        batch_op.create_foreign_key('fk_sport_event_sport_key_sport', 'sport', ['sport_key'], ['key']) # Give old FK a name too for downgrade

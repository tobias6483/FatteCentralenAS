...
from app.models import User, PrivateMessage # Assuming User is your SQLAlchemy User model
from app.forms import PrivateMessageForm
from app.utils import get_common_context, create_notification # For consistent template context & notifications

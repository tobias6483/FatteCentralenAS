...
badges_to_seed = [
    ...
    (
        "first_win",
        "Første Gevinst",
        "Tillykke med din første vundne bet!",
        "bi-trophy-fill",
        "success",
    ),
    (
        "coupon_creator",
        "Kupon Bygger",
        "Du har oprettet din første kupon-session!",
    ...
    (
        "high_roller",
        "Storspiller",
        "Du har placeret et bet over 100 DKK!",
        "bi-gem",
        "warning",
    ),
    (
    ...
    (
        "active_participant",
        "Aktiv Deltager",
        "Du har joinet 5 sessions!",
        "bi-people-fill",
        "info",
    ),
    (
        "forum_contributor_10",
        "Forum Skribent",
        "Du har skrevet 10 indlæg i forummet!",
    ...
    (
        "big_win_200",
        "Kassen Ringer",
        "Du har vundet over 200 DKK på et enkelt bet!",
        "bi-cash-stack",
        "success",
    ),
    (
        "session_starter_5",
        "Spilmester",
        "Du har oprettet 5 spilsessioner!",
        "bi-joystick",
        "info",
    ),
]
...
def seed_all_badges():
    ...
    with app.app_context():
        ...
        print(
            f"Badge seeding complete. Created: {created_count}, Skipped: {skipped_count}."
        )

...
class Config:
    ...
    if _session_cookie_secure_env is not None:
        _temp_session_secure: bool = _session_cookie_secure_env.lower() in ['true', '1', 'yes', 'on']
    else:
    ...
    SESSION_COOKIE_DOMAIN: Optional[str] = None # Allow cookie for any hostname used to access

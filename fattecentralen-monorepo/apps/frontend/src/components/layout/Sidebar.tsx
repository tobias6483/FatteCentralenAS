  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center border-b border-border pb-4" data-testid="sidebar-user-info">
        ...
        <p className="font-semibold text-lg" data-testid="sidebar-username">{mockUser.username}</p>
        <div className="text-sm text-muted-foreground flex items-center" data-testid="sidebar-balance">
          <Wallet2 className="h-4 w-4 mr-1" /> {mockUser.balance}
        </div>
        <div className="text-xs text-muted-foreground mt-1 space-y-0.5">
          <p data-testid="sidebar-uid">UID: {mockUser.uid}</p>
          <p data-testid="sidebar-invited-by">Inviteret af: {mockUser.invitedBy}</p>
        </div>
      </div>
      ...
      <div>
        <hr className="my-3 border-border" />
        <Button variant="ghost" className="w-full justify-start text-red-500 hover:!text-red-600 hover:!bg-red-500/10" data-testid="sidebar-logout-button">
